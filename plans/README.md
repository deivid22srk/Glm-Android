...
|---|------|----------|--------|--------|--------|--------|
| 010 | Fix captcha notification never fires on Android 13+ (request POST_NOTIFICATIONS) + add deleteIntent for swipe-dismiss | correctness | HIGH | S | TODO | C-01, C-02 |
